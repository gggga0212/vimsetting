...
_G.packer_plugins = {
  CCTree = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/CCTree",
  ...
  Trinity = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/Trinity",
    url = "https://github.com/wesleyche/Trinity"
  },
  ["a.vim"] = {
    loaded = true,
  ...
  ["better-comments.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/better-comments.nvim",
    url = "https://github.com/Djancyp/better-comments.nvim"
  },
  bufexplorer = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/bufexplorer",
    url = "https://github.com/jlanzarotta/bufexplorer"
  },
  ["ccls.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/ccls.nvim",
  ...
  ["codewindow.nvim"] = {
    ...
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/codewindow.nvim",
    url = "https://github.com/gorbit99/codewindow.nvim"
  },
  ["color-picker.nvim"] = {
    config = { "\27LJ\2\n,\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\17color-picker\frequire\0" },
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/color-picker.nvim",
  ...
  ["ctrlp.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/ctrlp.vim",
  ...
  ["lsp_lines.nvim"] = {
    ...
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/lsp_lines.nvim",
  ...
  ["nvim-ide"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-ide",
  ...
  syntastic = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/syntastic",
  ...
  ["telescope.nvim"] = {
    config = { "\27LJ\2\ns\0\0\3\0\5\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0'\2\3\0B\0\2\0016\0\0\0'\2\1\0B\0\2\0029\0\2\0'\2\4\0B\0\2\1K\0\1\0\19live_grep_args\flazygit\19load_extension\14telescope\frequire\0" },
    loaded = true,
  ...
  ["tokyonight-vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/tokyonight-vim",
  ...
  ["vim-gitdiffall"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-gitdiffall",
    url = "https://github.com/bootleq/vim-gitdiffall"
  },
  ["vim-material"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-material",
  ...
  ["vim-quickhl"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/vim-quickhl",
  ...
  ["winbar.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/winbar.nvim",
...
try_loadstring("\27LJ\2\ns\0\0\3\0\5\0\r6\0\0\0'\2\1\0B\0\2\0029\0\2\0'\2\3\0B\0\2\0016\0\0\0'\2\1\0B\0\2\0029\0\2\0'\2\4\0B\0\2\1K\0\1\0\19live_grep_args\flazygit\19load_extension\14telescope\frequire\0", "config", "telescope.nvim")
