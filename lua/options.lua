...
keymaps('n','<space>gk',':!cmd.exe /C start /max ./lazygit/lazygit.exe<CR>',              ntst)
...
keymaps('n','<leader>sd',':Telescope lsp_definitions<CR>', ntst)
keymaps('n','<leader>sr',':Telescope lsp_references<CR>',   ntst)
keymaps('n','<leader>st',':Telescope lsp_type_definitions<CR>', ntst)
...
keymaps('n','<C-H>',':TmuxNavigateLeft<CR>', ntsf)
keymaps('n','<C-K>',':TmuxNavigateUp<CR>', ntsf)
keymaps('n','<C-L>',':TmuxNavigateRight<CR>', ntsf)
keymaps('n','<C-J>',':TmuxNavigateDown<CR>', ntsf)
