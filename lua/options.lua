...
keymaps('n','cf','mZ* :Cs find f <C-R>=expand("<cfile>")<CR><CR>:cclose<CR>:Telescope quickfix<CR>',ntst)
keymaps('n','ci','mZ* :Cs find i <C-R>=expand("<cfile>")<CR><CR>:cclose<CR>:Telescope quickfix<CR>',ntst)
keymaps('n','cd','mZ* :Cs find d <C-R>=expand("<cword>")<CR><CR>:cclose<CR>:Telescope quickfix<CR>',ntst)
keymaps('n','cj',':<C-U><C-R>=printf("Cs find ")<CR>',ntsf)
...
keymaps('n','<leader>x',':Cs find f ble_gap.h<CR>',ntst)
